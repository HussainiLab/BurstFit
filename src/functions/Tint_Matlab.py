"""
This is a separate suite of functions adapted from MATLAB scripts,
to provide many of the funtionalities that the Tint software provides for 
loading neuronal data. 

Original author: GeoffBarrett
Github: https://github.com/GeoffBarrett
"""
